...
c.LocalGitHubOAuthenticator.oauth_callback_url = 'https://maphub.dev/jhub/oauth_callback'
c.LocalGitHubOAuthenticator.client_id = '798ba5fe8d518e873099'
c.LocalGitHubOAuthenticator.client_secret = 'e5a455f2e5b90922536147d845275c1a2374e207'
...
#  Default: '/home/ubuntu/miniconda3/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/ubuntu/miniconda3/share/jupyterhub'
...
#  Default: ''
#c.JupyterHub.ssl_cert = '/etc/letsencrypt/live/maphub.dev/fullchain.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#  When setting this, you should also set ssl_cert
#  Default: ''
#c.JupyterHub.ssl_key = '/etc/letsencrypt/live/maphub.dev/privkey.pem'
...
c.Spawner.notebook_dir = '/home/notebooks'

# Custom for DockerSpawner, mount to joyvan...
notebook_dir = os.environ.get('DOCKER_NOTEBOOK_DIR') or '/home/jovyan/notebooks'
c.DockerSpawner.notebook_dir = notebook_dir

# Harcoded Captain Value...
c.DockerSpawner.volumes = { '/home/notebooks' : notebook_dir }

c.DockerSpawner.cmd = ['jupyterhub-singleuser']
c.DockerSpawner.image = 'dmw2151/geo:latest'
...
#  Default: set()
c.Authenticator.admin_users = {"dmw2151"}
...
#  Default: set()
# c.Authenticator.allowed_users = {"captain", "diver"}
